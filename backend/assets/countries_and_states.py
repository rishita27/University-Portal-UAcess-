"""Countries and state static response data.

Authors:
    * Amrita Krishna <amrita@dal.ca>

This file contains the names of countries and states
The data is referred from this endpoint: https://countriesnow.space/api/v0.1/countries/states
"""
data = [
    {
        "name": "Afghanistan",
